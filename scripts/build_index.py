...
def get_refined_bias_lexicon() -> tuple[List[str], List[Dict[str, Any]]]:
    ...
    entries = [
        ...
        {"term": "empathetic", "category": "gender", "severity": "info", "replacement": "user-centric", "context": "empathetic communicator for customer success."},
        {"term": "warm", "category": "gender", "severity": "info", "replacement": "welcoming", "context": "warm and friendly office environment."},
        {"term": "helpful", "category": "gender", "severity": "info", "replacement": "service-oriented", "context": "helpful demeanor in resolving support tickets."},
        {"term": "caring", "category": "gender", "severity": "info", "replacement": "attentive", "context": "caring approach to employee well-being."},
        {"term": "soft-spoken", "category": "gender", "severity": "info", "replacement": "thoughtful communicator", "context": "soft-spoken professional for sensitive accounts."},
        {"term": "sensitive", "category": "gender", "severity": "info", "replacement": "attuned to user feedback", "context": "sensitive to client requirements and deadlines."},
        ...
        {"term": "approachable", "category": "gender", "severity": "info", "replacement": "accessible", "context": "approachable leader with open-door policy."},
        {"term": "detail-oriented", "category": "gender", "severity": "info", "replacement": "meticulous", "context": "detail-oriented auditor for financial reports."},
        {"term": "dependable", "category": "gender", "severity": "info", "replacement": "reliable", "context": "dependable asset to our operations team."},
        {"term": "interpersonal skills", "category": "gender", "severity": "info", "replacement": "communication capabilities", "context": "exceptional interpersonal skills required."},
